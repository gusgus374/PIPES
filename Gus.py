...
with st.echo(code_location="below"):
    ...
    info = {'Name': ['Zeb','Mirie','Dani'], 'Hobby':['Motorcycle Racing','Drawing','Video Games'], 'Educational Interest': ['Engineering/physics','Kinesiology','Veterinary Science'], 'Favorite Sport': ['Baseball', 'Soccer', 'Baseball'], 'Grade Level': ['Senior','Senior','Junior'], 'Current School':['Sequoyah HS','Sweetwater HS', 'Sequoya HS']}
